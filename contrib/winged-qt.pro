...
RESOURCES += src/qt/winged.qrc src/qt/winged_locale.qrc

TRANSLATIONS += src/qt/locale/winged_bg.ts \
                src/qt/locale/winged_de.ts \
                src/qt/locale/winged_en.ts \
                src/qt/locale/winged_es.ts \
                src/qt/locale/winged_fi.ts \
                src/qt/locale/winged_fr.ts \
                src/qt/locale/winged_it.ts \
                src/qt/locale/winged_ja.ts \
                src/qt/locale/winged_pl.ts \
                src/qt/locale/winged_pt.ts \
                src/qt/locale/winged_ru.ts \
                src/qt/locale/winged_sk.ts \
                src/qt/locale/winged_sv.ts \
                src/qt/locale/winged_vi.ts \
                src/qt/locale/winged_zh_CN.ts \
                src/qt/locale/winged_zh_TW.ts
