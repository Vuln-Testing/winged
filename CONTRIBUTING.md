Contributing to Winged Core
============================

The Winged Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Winged Core project, and is not to be
confused with overall Winged Network Protocol consensus changes.

Whether a pull request is merged into Winged Core rests with the project merge
...
Patches that change Winged consensus rules are considerably more involved than
...
Where a patch set proposes to change the Winged consensus, it must have been
...
The project leader is the release manager for each Winged Core release.
