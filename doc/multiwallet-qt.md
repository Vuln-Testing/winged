...
In order to support loading of multiple wallets in winged-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is winged.cpp.
...
Changes to winged.cpp
----------------------
winged.cpp is the entry point into winged-qt, and as such, will require some minor modifications to provide hooks for
