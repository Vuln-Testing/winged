...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Winged features */
        {"winged", "masternode", &masternode, true, true, false},
        {"winged", "listmasternodes", &listmasternodes, true, true, false},
        {"winged", "getmasternodecount", &getmasternodecount, true, true, false},
        {"winged", "masternodeconnect", &masternodeconnect, true, true, false},
        {"winged", "masternodecurrent", &masternodecurrent, true, true, false},
        {"winged", "masternodedebug", &masternodedebug, true, true, false},
        {"winged", "startmasternode", &startmasternode, true, true, false},
        {"winged", "createmasternodekey", &createmasternodekey, true, true, false},
        {"winged", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"winged", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"winged", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"winged", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"winged", "getmasternodescores", &getmasternodescores, true, true, false},
        {"winged", "mnbudget", &mnbudget, true, true, false},
        {"winged", "preparebudget", &preparebudget, true, true, false},
        {"winged", "submitbudget", &submitbudget, true, true, false},
        {"winged", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"winged", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"winged", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"winged", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"winged", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"winged", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"winged", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"winged", "checkbudgets", &checkbudgets, true, true, false},
        {"winged", "mnsync", &mnsync, true, true, false},
        {"winged", "spork", &spork, true, true, false},
        {"winged", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"winged", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wingedd, or the -server option to winged-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> winged-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1616/\n";
}
