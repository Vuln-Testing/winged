                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Winged [WINGE]") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Winged address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and winged: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWINGE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Winged Core"), this);
    aboutAction->setStatusTip(tr("Show information about Winged Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Winged"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Winged addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Winged addresses"));
    ...
    openAction->setStatusTip(tr("Open a Winged: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Winged Core help message to get a list with possible Winged command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Winged Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Winged network", "", count));
}
...
{
    QString strTitle = tr("Winged [WINGE]"); // default title
