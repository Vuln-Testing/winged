...
/** Utility functions used by the Winged Qt UI.
 */
namespace GUIUtil
{
...
// Render Winged addresses in monospace font
...
// Parse "winged:" URI into recipient object, return true on successful parsing
