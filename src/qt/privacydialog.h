...
public:
    ...
    void setZWingeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzWINGE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzWINGE_clicked();
    void on_pushButtonZWingeControl_clicked();
