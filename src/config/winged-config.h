/* src/config/winged-config.h.  Generated from winged-config.h.in by configure.  */
/* src/config/winged-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WINGE_CONFIG_H

#define WINGE_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.wingedex.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Winged Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Winged Core 4.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "winged"
